            ...
            <div className="space-y-4">
              {applications.map((application) => (
                ...
                >
                  ...
                  {/* Pending Users */}
                  {application.pending_users &&
                    application.pending_users.length > 0 && (
                      <div className="bg-gradient-to-br from-amber-50 to-orange-50 rounded-2xl p-3 mb-3">
                        ...
                        <div className="space-y-2">
                          {application.pending_users.map((user, index) => (
                            <div
                              key={index}
                              className="bg-white rounded-xl p-2 text-xs"
                            >
                              <p className="font-semibold text-gray-900">
                                {user.name}
                              </p>
                  ...
                  {/* Last User */}
                  {application.last_user &&
                    application.last_user.length > 0 && (
